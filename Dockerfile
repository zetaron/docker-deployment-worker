...
LABEL org.label-schema.schema-version="1.0" \
      ...
      org.label-schema.docker.cmd="docker run -d -v $SECRETS_VOLUME_NAME:/var/cache/secrets:ro -v $DEPLOYMENT_CACHE_VOLUME_NAME:/var/cache/deployment zetaron/docker-deployment-worker:1.0.0"
...
RUN curl -L "https://github.com/docker/compose/releases/download/${DOCKER_COMPOSE_VERSION}/docker-compose-Linux-$(uname -m)" > /usr/bin/docker-compose \
